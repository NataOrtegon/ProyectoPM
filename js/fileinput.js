...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        renderRemove: function () {
            ...
            return '<input type="button" class="' + css + '"' + status + '>' + self.removeIcon + self.removeLabel + '</input>';
        },
        renderUpload: function () {
            ...
            if (isEmpty(self.uploadUrl)) {
                content = '<input type="hidden" class="' + self.uploadClass + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</input>';
            }
            else {
